...
def mann_whitney_plus_means(turnstile_weather):
    ...
    '''
    with_rain_mean = scipy.mean(turnstile_weather['ENTRIESn_hourly'][turnstile_weather['rain']==1])
    without_rain_mean = scipy.mean(turnstile_weather['ENTRIESn_hourly'][turnstile_weather['rain']==0])
